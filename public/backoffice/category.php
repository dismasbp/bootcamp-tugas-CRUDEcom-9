...
$totalCategories    = $countResult ? (int) $countResult->fetch_assoc()['total'] : 0;
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-auto mb-1">
                                        <a href="edit/category.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning" title="Edit">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteModalLabel-<?= $row['id']; ?>">Delete Category</h5>
                                                ...
                                                <div class="modal-footer justify-content-center">
                                                    <form action="Controller/category/delete_category.php" method="POST" class="d-inline">
